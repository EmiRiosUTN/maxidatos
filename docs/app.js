/**
 * MaxiDatos - Interactive Frontend
 * ====================================
 * Features:
...
function renderLawVotacion(v, idx, totalCount) {
    ...
    const href = v.url || "";
    if (href) {
        linkHtml = `<a class="law-votacion-link" href="${escapeAttr(href)}" target="_blank" title="Ver votación original">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="14" height="14" style="vertical-align: middle;"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>
        </a>`;
    }
...
function shareRanking(prefix) {
    ...
    const text = `Mirá el ${rankingName} de legisladores en MaxiDatos`;
    ...
    tbody.innerHTML = pageVotes
        .map(
            (v) => {
                ...
                if (href) {
                    linkHtml = `<a class="vote-link" href="${escapeAttr(href)}" target="_blank" title="Ver votación original">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="14" height="14" style="vertical-align: middle;"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>
                    </a>`;
                }
